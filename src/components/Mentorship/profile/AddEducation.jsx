...
const AddEducation = () => {
  ...
  const getEducationList = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/mentor/getEducationList`,
        {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/mentor/deleteEducation/${educationToDelete}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
  ...
  return (
    <>
      <div>
        ...
        {/* Render the modal */}
        <EducationForm isOpen={isModalOpen} onClose={closeModal} currentEducation={currentEducation} educationType={educationType} />
