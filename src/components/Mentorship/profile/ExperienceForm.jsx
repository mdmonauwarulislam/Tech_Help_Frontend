...
const ExperienceForm = ({ isOpen, onClose, workExperienceId }) => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      if (workExperienceId) {
        ...
        await axios.put(`${import.meta.env.VITE_API_URL}/mentor/updateWorkExperience/${workExperienceId}`, workExperienceDetails,{
          headers: {
        ...
        await axios.post(`${import.meta.env.VITE_API_URL}/mentor/addWorkExperience`, workExperienceDetails,{
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          }
        });
