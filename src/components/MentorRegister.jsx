...
import MentorImage from "../assets/mentorimage.jpg";
...
function MentorRegister() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 ">
      {/* left */}
      <div className="hidden md:flex flex-col min-h-screen border-2 border-primary justify-center items-center rounded-r-3xl" style={{
      ...
      <div className="flex items-center justify-center p-4 md:p-6 text-primary">
        <section className="bg-white w-full max-w-md ">
          <div className="flex flex-col gap-6">
            ...
            Register yourself as Mentor
            </h2>
            <form className="flex flex-col" onSubmit={handleSubmit}>
            <label className="text-lg font-medium mb-1">Enter Mentor Name</label>
              <input
                ...
                required
              />
              <label className="text-lg font-medium mt-4 mb-1">Enter mentor email</label>
              <input
                className="py-2 px-4 rounded-md border border-gray-300 outline-none focus:border-techBlue-500"
                type="email"
              ...
              <label className="text-lg mb-1 mt-4">
                Enter Password
              </label>
              <input
                className="py-2 px-4 rounded-md border border-gray-300 outline-none focus:border-techBlue-500"
